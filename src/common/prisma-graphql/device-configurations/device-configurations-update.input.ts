...
import { DeviceUpdateOneRequiredWithoutDeviceConfigurationsNestedInput } from '../device/device-update-one-required-without-device-configurations-nested.input';

@InputType()
export class DeviceConfigurationsUpdateInput {
    ...
    @Field(() => DeviceUpdateOneRequiredWithoutDeviceConfigurationsNestedInput, {nullable:true})
    device?: DeviceUpdateOneRequiredWithoutDeviceConfigurationsNestedInput;
}

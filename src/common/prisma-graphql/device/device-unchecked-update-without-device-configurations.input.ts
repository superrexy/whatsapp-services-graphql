...
import { MessageHistoryUncheckedUpdateManyWithoutDeviceNestedInput } from '../message-history/message-history-unchecked-update-many-without-device-nested.input';

@InputType()
export class DeviceUncheckedUpdateWithoutDeviceConfigurationsInput {
    ...
    @Field(() => MessageHistoryUncheckedUpdateManyWithoutDeviceNestedInput, {nullable:true})
    MessageHistory?: MessageHistoryUncheckedUpdateManyWithoutDeviceNestedInput;
}

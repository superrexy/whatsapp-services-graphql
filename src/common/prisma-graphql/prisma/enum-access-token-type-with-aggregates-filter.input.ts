...
import { NestedEnumAccessTokenTypeWithAggregatesFilter } from './nested-enum-access-token-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumAccessTokenTypeFilter } from './nested-enum-access-token-type-filter.input';

@InputType()
export class EnumAccessTokenTypeWithAggregatesFilter {
